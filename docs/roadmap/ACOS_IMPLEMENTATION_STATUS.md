...
BLOCKED: Staff Review migration, guarded actions, settlement runtime, Admin review UI, bank instruction configuration, private proof Storage, Production preflight/apply and public activation remain unauthorized; P16 remains mandatory for Production
