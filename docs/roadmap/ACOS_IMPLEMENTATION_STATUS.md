...
| Phase 1D Manual Payment Part 4B Staff Review Service Contract | `docs/api-contracts/ACOS_PHASE_1D_MANUAL_PAYMENT_PART4B_STAFF_REVIEW_SERVICE_CONTRACT_REVIEW.md` | CONTRACT REVIEW COMPLETE / RV01-RV24 OWNER DECISION REQUIRED | Recommends exact queue/detail reads, reference privacy, approve/reject actions, review idempotency, direct-write revocation, atomic settlement and post-commit handoffs without authorizing implementation |
...
BLOCKED: RV01-RV24 Owner freeze, Staff Review migration, guarded actions, settlement runtime, Admin review UI, bank instruction configuration, private proof Storage, Production preflight/apply and public activation remain unauthorized; P16 remains mandatory for Production
