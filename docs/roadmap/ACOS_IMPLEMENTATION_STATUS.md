...
BLOCKED: Part 4C migration contract review, Staff Review SQL, guarded actions, settlement runtime, Admin review UI, bank instruction configuration, private proof Storage, Production preflight/apply and public activation remain unauthorized; P16 remains mandatory for Production
