...
BLOCKED: no exact canonical HTTPS origin, approved hosting/Supabase production project, production Turnstile hostname, Resend sender/domain/DNS evidence, secret map, quota evidence, monitoring, rollout or recovery disposition
