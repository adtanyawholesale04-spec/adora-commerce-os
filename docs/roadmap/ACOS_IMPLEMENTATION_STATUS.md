...
NEXT: Build the Customer Portal read-only UI/server adapter against the validated RPC; keep notification recipient mapping, consent writes, and provider runtime separately gated
