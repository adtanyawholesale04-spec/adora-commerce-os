...
BLOCKED: Part 3D SQL requires a frozen Coupon Evaluation Subcontract, proven automatic/coupon campaign separation, non-destructive coupon constraint preflight and separate migration authorization; Production apply, Part 3E runtime, real payment/provider work and production activation remain unauthorized
