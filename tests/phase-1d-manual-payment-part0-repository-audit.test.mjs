...
test("status advances to the manual payment contract decision gate", () => {
  ...
  assert.match(
    status,
    /BLOCKED: Part 1B-1C decision freeze, manual payment migration, customer submission, staff verification, private proof Storage[\s\S]*P16 remains mandatory for Production/,
  );
});
