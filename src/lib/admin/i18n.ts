...
export const adminCopy = {
  en: {
    ...
    users: {
      ...
      persistenceDisabled: "Persistence service ready; submit remains disabled until UI validation",
      persistenceEnabled: "Invite persistence + Auth email boundary enabled",
      auditRequired: "Audit required before persistence",
      submitDisabled: "Disabled until UI validation",
      submitReady: "Ready to submit",
      submitInvite: "Request invite",
      submitting: "Submitting...",
      emailRequired: "Email is required.",
      emailInvalid: "Enter a valid email address.",
      dbOnlyInviteBoundary: "Creates an audited pending invite, then sends the Supabase Auth invite from a server-only boundary.",
      roleAssignmentDeferred: "Deferred until invitation-role persistence is approved",
      roleAssignmentAction: "Assign member role",
      roleAssignmentBoundary: "Assigns one active non-system role to one active member through the audited guarded server boundary.",
      roleAssignmentPersistenceEnabled: "Role assignment RPC + audit enabled",
      roleAssignmentServiceReady: "Guarded role assignment enabled",
      selectMember: "Select member",
      selectRole: "Select role",
      assignRole: "Assign role",
      reason: "Reason",
      roleAssignmentReasonPlaceholder: "Optional reason for audit trail",
      roleReasonTooLong: "Reason must be 500 characters or fewer.",
      noAssignableMembers: "No active assignable members are available.",
      noAssignableRoles: "No active non-system roles remain for this member.",
      roleAssignmentPersisted: "Role assignment saved",
      roleAssignmentDuplicate: "Role assignment already existed",
      roleAssignmentFailed: "Role assignment failed",
      roleRemovalAction: "Remove member role",
      roleRemovalBoundary: "Removes one active non-system role through the audited guarded server boundary and blocks the last remaining role.",
      roleRemovalPersistenceEnabled: "Role removal RPC + audit enabled",
      roleRemovalServiceReady: "Guarded role removal enabled",
      roleRemovalReasonPlaceholder: "Optional reason for audit trail",
      removeRole: "Remove role",
      roleRemovalConfirm: "Remove this role from the member? This action is audited and cannot be undone from this screen.",
      noRemovableMembers: "No active members are available for role removal.",
      noRemovableRoles: "No active non-system roles are assigned to this member.",
      lastRoleRemovalBlocked: "The member must keep at least one role.",
      roleRemovalPersisted: "Role removed",
      roleRemovalAlreadyRemoved: "Role was already removed",
      roleRemovalFailed: "Role removal failed",
      invitePersisted: "Invite request saved",
      inviteReused: "Pending invite reused",
      inviteFailed: "Invite request failed",
      inviteEmailSent: "Auth invite email sent.",
      inviteEmailAlreadySent: "Auth invite email was already sent.",
      inviteEmailPending: "Auth invite email pending.",
  ...
  th: {
    ...
    users: {
      ...
      persistenceDisabled: "persistence service พร้อมแล้ว แต่ยังปิด submit จนกว่า UI validation จะผ่าน",
      persistenceEnabled: "เปิด invite persistence + Auth email boundary แล้ว",
      auditRequired: "ต้องมี audit ก่อนเปิด persistence",
      submitDisabled: "ปิดไว้จนกว่า UI validation จะผ่าน",
      submitReady: "พร้อม submit",
      submitInvite: "ส่งคำขอเชิญ",
      submitting: "กำลังส่ง...",
      emailRequired: "ต้องระบุอีเมล",
      emailInvalid: "ใส่อีเมลให้ถูกต้อง",
      dbOnlyInviteBoundary: "สร้าง pending invite พร้อม audit แล้วส่ง Supabase Auth invite จาก server-only boundary",
      roleAssignmentDeferred: "เลื่อนไปจนกว่า invitation-role persistence จะ approved",
      roleAssignmentAction: "กำหนดบทบาทให้สมาชิก",
      roleAssignmentBoundary: "กำหนด active non-system role ให้ active member ผ่าน guarded server boundary พร้อม audit",
      roleAssignmentPersistenceEnabled: "เปิด role assignment RPC + audit แล้ว",
      roleAssignmentServiceReady: "เปิด guarded role assignment แล้ว",
      selectMember: "เลือกสมาชิก",
      selectRole: "เลือกบทบาท",
      assignRole: "กำหนดบทบาท",
      reason: "เหตุผล",
      roleAssignmentReasonPlaceholder: "เหตุผลสำหรับ audit trail (ไม่บังคับ)",
      roleReasonTooLong: "เหตุผลต้องไม่เกิน 500 ตัวอักษร",
      noAssignableMembers: "ไม่มีสมาชิก active ที่กำหนดบทบาทได้",
      noAssignableRoles: "ไม่มี active non-system role ที่เหลือสำหรับสมาชิกนี้",
      roleAssignmentPersisted: "บันทึกบทบาทแล้ว",
      roleAssignmentDuplicate: "สมาชิกมีบทบาทนี้อยู่แล้ว",
      roleAssignmentFailed: "กำหนดบทบาทไม่สำเร็จ",
      roleRemovalAction: "ถอดบทบาทสมาชิก",
      roleRemovalBoundary: "ถอด active non-system role ผ่าน guarded server boundary พร้อม audit และป้องกันไม่ให้สมาชิกเหลือ role ศูนย์รายการ",
      roleRemovalPersistenceEnabled: "เปิด role removal RPC + audit แล้ว",
      roleRemovalServiceReady: "เปิด guarded role removal แล้ว",
      roleRemovalReasonPlaceholder: "เหตุผลสำหรับ audit trail (ไม่บังคับ)",
      removeRole: "ถอดบทบาท",
      roleRemovalConfirm: "ต้องการถอดบทบาทนี้จากสมาชิกใช่หรือไม่ การกระทำนี้จะถูกบันทึก audit และย้อนกลับจากหน้านี้ไม่ได้",
      noRemovableMembers: "ไม่มีสมาชิก active ที่พร้อมให้ถอดบทบาท",
      noRemovableRoles: "สมาชิกนี้ไม่มี active non-system role ที่ถอดได้",
      lastRoleRemovalBlocked: "สมาชิกต้องเหลืออย่างน้อยหนึ่ง role",
      roleRemovalPersisted: "ถอดบทบาทแล้ว",
      roleRemovalAlreadyRemoved: "บทบาทนี้ถูกถอดไปแล้ว",
      roleRemovalFailed: "ถอดบทบาทไม่สำเร็จ",
      invitePersisted: "บันทึกคำขอเชิญแล้ว",
      inviteReused: "ใช้ pending invite เดิม",
      inviteFailed: "ส่งคำขอเชิญไม่สำเร็จ",
      inviteEmailSent: "ส่งอีเมล Auth invite แล้ว",
      inviteEmailAlreadySent: "อีเมล Auth invite เคยถูกส่งแล้ว",
      inviteEmailPending: "อีเมล Auth invite ยังรอดำเนินการ",
      inviteEmailPreview: "new.user@example.com",
