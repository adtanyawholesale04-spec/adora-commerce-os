...
export const adminCopy = {
  en: {
    ...
    manualPaymentReview: {
      pageCode: "PHASE-1D-4G-B",
      pageTitle: "Manual payment review",
      pageDescription: "Oldest pending bank-transfer claims, limited to the active organization and safe review fields.",
      backToPayments: "Back to payments",
      queueEntry: "Review manual payments",
      queueTitle: "Pending review queue",
      queueDescription: "Oldest submissions appear first. Open each claim separately before any financial action.",
      referenceProtected: "Payment references are protected from this queue",
      ...
      reviewState: "Review state",
        detail: "Detail",
        detailTitle: "Open private detail",
        opaqueIdentity: "Opaque transaction ID",
      readyForReview: "Ready for review",
      viewOnly: "View only",
      detailPending: "Detail locked",
      detailPendingTitle: "Private detail is delivered separately in Part 4G-C",
      pageCount: "Items on this page",
      loadMore: "Load next page",
      endOfQueue: "End of current queue",
      emptyTitle: "No payments are waiting for review",
      emptyDetail: "New eligible bank-transfer claims will appear here in oldest-first order.",
      disabledTitle: "Manual payment review is disabled",
      disabledDetail: "The server feature gate remains closed. No payment reference or review action is available.",
      anonymousTitle: "Sign in is required",
      anonymousDetail: "Sign in with an active organization membership to view this queue.",
      membershipTitle: "Active organization access is required",
      membershipDetail: "Select an active organization membership before opening the review queue.",
      permissionTitle: "Payment review queue is unavailable",
      permissionDetail: "The active membership does not have permission to read this queue.",
      unavailableTitle: "Review queue is unavailable",
      unavailableDetail: "The requested queue position is unavailable. Return to Payments and open the queue again.",
        errorTitle: "Review queue could not be loaded",
        errorDetail: "The protected read boundary did not return a valid queue. No private detail was exposed.",
        detailPageCode: "PHASE-1D-4G-C",
        detailPageTitle: "Manual payment review detail",
        detailPageDescription: "Private review evidence for the active organization. Financial actions remain separately guarded.",
        backToQueue: "Back to review queue",
        detailSummary: "Review summary",
        noStoreNotice: "This private view is server-fetched and is not cached.",
        privateDetail: "Private review detail",
        canonicalIds: "Canonical IDs",
        transactionId: "Payment transaction ID",
        paymentId: "Payment ID",
        proofId: "Payment proof ID",
        orderId: "Order ID",
        privateReference: "Payment reference",
        referencePrivacyDetail: "Visible only in this protected detail view. It is not placed in the URL, metadata, logs or browser storage.",
        status: "Current status",
        transactionStatus: "Transaction status",
        proofStatus: "Proof status",
        orderStatus: "Order status",
        paymentStatus: "Payment status",
        actionBoundaryTitle: "Review actions",
        actionBoundaryDetail: "Approval and rejection controls are implemented separately and are not available from this detail view yet.",
        reviewBlockedDetail: "This item cannot be reviewed from the current state or reviewer context.",
        actionsNextPart: "Guarded actions arrive in Part 4G-D",
        eligible: "Eligible",
        ineligible: "Not eligible",
        verifyAction: "Approve payment",
        rejectAction: "Reject payment",
        verifyConfirmTitle: "Approve this payment claim?",
        rejectConfirmTitle: "Reject this payment claim?",
        verifyConfirmDetail: "This sends the approved request through the guarded payment boundary. The server remains the financial authority.",
        rejectConfirmDetail: "This sends the rejection through the guarded payment boundary. The server remains the financial authority.",
        reason: "Review reason",
        reasonHint: "Use 8-500 characters. Do not enter passwords, full bank details or secrets.",
        reasonRequired: "A reason of at least 8 characters is required.",
        reasonTooLong: "The reason must be 500 characters or fewer.",
        reasonRemaining: "characters remaining",
        cancel: "Cancel",
        confirm: "Confirm",
        submitting: "Submitting",
        retry: "Retry",
        actionSuccess: "Review action completed",
        verifySuccess: "Payment claim approved by the guarded service.",
        rejectSuccess: "Payment claim rejected by the guarded service.",
        actionError: "Review action was not completed",
        actionErrorDetail: "The protected service did not complete this action. No financial state was assumed.",
        conflictDetail: "The item changed or is no longer pending. Refresh the detail before trying again.",
        retryableDetail: "The request can be retried with the same reason and request identity.",
        permissionActionDetail: "Your active membership cannot perform this review action.",
        actionUnavailableDetail: "The review action is currently unavailable. No change was made."
    },
    fulfillment: {
  ...
  th: {
    ...
    manualPaymentReview: {
      pageCode: "PHASE-1D-4G-B",
      pageTitle: "ตรวจสอบการชำระเงินด้วยตนเอง",
      pageDescription: "คิวแจ้งโอนเงินที่รอตรวจ เรียงจากรายการเก่าสุด และแสดงเฉพาะข้อมูลที่ปลอดภัยขององค์กรที่ใช้งานอยู่",
      backToPayments: "กลับไปการชำระเงิน",
      queueEntry: "ตรวจรายการแจ้งชำระเงิน",
      queueTitle: "คิวรอตรวจสอบ",
      queueDescription: "รายการเก่าสุดจะแสดงก่อน และต้องเปิดตรวจแต่ละรายการก่อนดำเนินการทางการเงิน",
      referenceProtected: "คิวนี้ไม่แสดงเลขอ้างอิงการชำระเงิน",
      transaction: "ธุรกรรม",
      submittedAt: "แจ้งเมื่อ",
      deadline: "กำหนดชำระ",
      amount: "จำนวนเงิน",
      reviewState: "สถานะตรวจสอบ",
        detail: "รายละเอียด",
        detailTitle: "เปิดรายละเอียดส่วนตัว",
        opaqueIdentity: "รหัสธุรกรรมแบบไม่เปิดเผยข้อมูล",
      readyForReview: "พร้อมตรวจสอบ",
      viewOnly: "ดูได้อย่างเดียว",
      detailPending: "รายละเอียดยังล็อก",
      detailPendingTitle: "หน้ารายละเอียดส่วนตัวจะพัฒนาแยกใน Part 4G-C",
      pageCount: "รายการในหน้านี้",
      loadMore: "โหลดหน้าถัดไป",
      endOfQueue: "สิ้นสุดคิวปัจจุบัน",
      emptyTitle: "ไม่มีรายการชำระเงินรอตรวจสอบ",
      emptyDetail: "เมื่อมีรายการแจ้งโอนที่เข้าเงื่อนไข ระบบจะแสดงที่นี่โดยเรียงจากรายการเก่าสุด",
      disabledTitle: "ระบบตรวจสอบการชำระเงินยังไม่เปิด",
      disabledDetail: "Feature gate ฝั่งเซิร์ฟเวอร์ยังปิดอยู่ จึงไม่มีเลขอ้างอิงหรือคำสั่งตรวจสอบให้ใช้งาน",
      anonymousTitle: "ต้องเข้าสู่ระบบ",
      anonymousDetail: "เข้าสู่ระบบด้วยสมาชิกองค์กรที่ใช้งานอยู่เพื่อดูคิวนี้",
      membershipTitle: "ต้องมีสิทธิ์ในองค์กรที่ใช้งานอยู่",
      membershipDetail: "เลือกสมาชิกองค์กรที่ active ก่อนเปิดคิวตรวจสอบ",
      permissionTitle: "ไม่สามารถเปิดคิวตรวจสอบได้",
      permissionDetail: "สมาชิกที่ใช้งานอยู่ไม่มีสิทธิ์อ่านคิวนี้",
      unavailableTitle: "ไม่สามารถเปิดตำแหน่งคิวนี้ได้",
      unavailableDetail: "ตำแหน่งคิวที่ร้องขอไม่พร้อมใช้งาน ให้กลับไปหน้า Payments แล้วเปิดคิวใหม่",
        errorTitle: "โหลดคิวตรวจสอบไม่สำเร็จ",
        errorDetail: "ขอบเขตการอ่านที่ป้องกันไว้ไม่ส่งผลลัพธ์ที่ถูกต้อง และไม่มีข้อมูลส่วนตัวถูกเปิดเผย",
        detailPageCode: "PHASE-1D-4G-C",
        detailPageTitle: "รายละเอียดตรวจสอบการชำระเงิน",
        detailPageDescription: "หลักฐานส่วนตัวขององค์กรที่ใช้งานอยู่ โดยคำสั่งทางการเงินยังอยู่ในขอบเขต guarded แยกต่างหาก",
        backToQueue: "กลับไปคิวตรวจสอบ",
        detailSummary: "สรุปการตรวจสอบ",
        noStoreNotice: "หน้านี้อ่านจากเซิร์ฟเวอร์และไม่ถูก cache",
        privateDetail: "รายละเอียดส่วนตัว",
        canonicalIds: "รหัสอ้างอิงในระบบ",
        transactionId: "รหัสธุรกรรมการชำระเงิน",
        paymentId: "รหัสการชำระเงิน",
        proofId: "รหัสหลักฐานการชำระเงิน",
        orderId: "รหัสคำสั่งซื้อ",
        privateReference: "เลขอ้างอิงการชำระเงิน",
        referencePrivacyDetail: "แสดงเฉพาะในหน้ารายละเอียดที่ป้องกันไว้ ไม่ใส่ใน URL metadata log หรือ browser storage",
        status: "สถานะปัจจุบัน",
        transactionStatus: "สถานะธุรกรรม",
        proofStatus: "สถานะหลักฐาน",
        orderStatus: "สถานะคำสั่งซื้อ",
        paymentStatus: "สถานะการชำระเงิน",
        actionBoundaryTitle: "ขอบเขตคำสั่งตรวจสอบ",
        actionBoundaryDetail: "คำสั่งอนุมัติและปฏิเสธจะพัฒนาแยก และยังไม่เปิดจากหน้ารายละเอียดนี้",
        reviewBlockedDetail: "รายการนี้ยังดำเนินการตรวจไม่ได้จากสถานะหรือบริบทของผู้ตรวจปัจจุบัน",
        actionsNextPart: "คำสั่ง guarded จะมาใน Part 4G-D",
        eligible: "ตรวจได้",
        ineligible: "ตรวจไม่ได้",
        verifyAction: "อนุมัติการชำระเงิน",
        rejectAction: "ปฏิเสธการชำระเงิน",
        verifyConfirmTitle: "ยืนยันอนุมัติรายการนี้หรือไม่",
        rejectConfirmTitle: "ยืนยันปฏิเสธรายการนี้หรือไม่",
        verifyConfirmDetail: "ระบบจะส่งคำสั่งผ่านขอบเขต guarded ที่ป้องกันไว้ โดย server ยังคงเป็นแหล่งความจริงทางการเงิน",
        rejectConfirmDetail: "ระบบจะส่งคำสั่งปฏิเสธผ่านขอบเขต guarded ที่ป้องกันไว้ โดย server ยังคงเป็นแหล่งความจริงทางการเงิน",
        reason: "เหตุผลการตรวจสอบ",
        reasonHint: "ใช้ 8-500 ตัวอักษร ห้ามใส่รหัสผ่าน รายละเอียดบัญชีธนาคารเต็มรูปแบบ หรือข้อมูลลับ",
        reasonRequired: "ต้องระบุเหตุผลอย่างน้อย 8 ตัวอักษร",
        reasonTooLong: "เหตุผลต้องไม่เกิน 500 ตัวอักษร",
        reasonRemaining: "ตัวอักษรที่เหลือ",
        cancel: "ยกเลิก",
        confirm: "ยืนยัน",
        submitting: "กำลังส่งคำสั่ง",
        retry: "ลองใหม่",
        actionSuccess: "ดำเนินการตรวจสอบสำเร็จ",
        verifySuccess: "บริการ guarded อนุมัติรายการชำระเงินแล้ว",
        rejectSuccess: "บริการ guarded ปฏิเสธรายการชำระเงินแล้ว",
        actionError: "ดำเนินการตรวจสอบไม่สำเร็จ",
        actionErrorDetail: "บริการที่ป้องกันไว้ยังดำเนินการไม่สำเร็จ ระบบจะไม่สรุปสถานะทางการเงินเอง",
        conflictDetail: "รายการเปลี่ยนแปลงหรือไม่อยู่ในสถานะรอตรวจแล้ว ให้โหลดรายละเอียดใหม่ก่อนลองอีกครั้ง",
        retryableDetail: "สามารถลองใหม่ด้วยเหตุผลเดิมและรหัสคำขอเดิมได้",
        permissionActionDetail: "สมาชิกองค์กรที่ใช้งานอยู่ไม่มีสิทธิ์ดำเนินการตรวจสอบนี้",
        actionUnavailableDetail: "คำสั่งตรวจสอบยังไม่พร้อมใช้งาน และไม่มีการเปลี่ยนแปลงใดเกิดขึ้น"
    },
    fulfillment: {
      pageCode: "CORE-UI-007",
      pageTitle: "Fulfillment",
  ...
  AdminLocale,
  {
    ...
    manualPaymentReview: Record<string, string>;
