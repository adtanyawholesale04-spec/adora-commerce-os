...
### Added — Advanced Promotion Targeting & Bundles
...
### Architecture impact
- Promotion targeting รองรับ SKU/Group/Category/Tier/Customer Tag/Product Tag
- เพิ่ม Bundle/Set pricing
- เพิ่ม Tiered Quantity Pricing
- เพิ่ม Virtual Trigger Code เช่น Free Shipping Code
- เพิ่ม Promotion Rule Builder และ Simulator


### Added — Promotion Data Model Draft v1
- Generic Promotion Model
- Condition Tree
- Mix/Tier/Bundle/Reward data model
- Trigger Code แยกจาก Inventory
...
### Added — ER Diagram v1.1 Draft
- Consolidated all core domains into one relational model
- Added Purchase Session
- Added Order Hold + Consolidation
- Added Inventory Allocation separate from Reservation
- Added Credit and Loyalty ledgers
- Integrated Promotion Data Model
- Added Fulfillment spanning multiple Orders
- Added Notification Engine
- Added Integration Event and Audit boundaries
...
### Closed — OPEN-001 to OPEN-005
- Defined promotion return/clawback policy
- Defined Purchase Session promotion boundary
- Selected ledger + maintained projection balance strategy
- Selected explicit Promotion Versioning
- Defined In-app Notification as source of truth

### Added Rules
- BR-107 through BR-116

### Milestone
ER Diagram v1.1 is ready to freeze for PostgreSQL/Supabase schema drafting.

### Added — Product Coding Model
- Separated product_code, variant_id, stock_code, sale_code/live_code
- Added contextual sales_code_assignments
- Sale Code can be reused across Live Sessions
- Added structured Variant Options
- Inventory remains linked to Variant ID

### Added Rules
- BR-117 through BR-123


### Added — SaaS Access & Subscription Model
- Added plans and features
- Added plan_features
- Added organization_subscriptions
- Added organization_entitlements
- Added subscription_usage
- Added organization_invitations
- Added support_access_grants
- Formalized 4-gate authorization model
- Merchant roles separated from platform staff roles

### Added Business Rules
- BR-124 through BR-135


### Added — Warehouse Picking & QC
- Added QC sessions, scan logs, and QC item totals
- Barcode / Stock Code / contextual Sale Code supported
- Wrong scan and over-scan rejected
- Final Label gated by QC PASSED
- QC override requires permission, reason, and audit
- QC does not directly deduct inventory

### Added Business Rules
- BR-136 through BR-144
